...
if(!file.exists("~/dva/files/bmi_t2d.txt")){
    bmi_t2d <- vroom::vroom(
                          ## Using hg19 position
                          pipe(
                              paste0(
                                  ...
                                  "$1 in a {print a[$1], \"\t\", $0}\' ",
                                  "~/dva/files/bmi.txt ~/dva/files/t2d.txt"
                              )
                          ),
    ...
    vroom::vroom_write(bmi_t2d, "~/dva/files/bmi_t2d.txt")
    setDT(bmi_t2d)
} else {
    bmi_t2d <- vroom::vroom("~/dva/files/bmi_t2d.txt")
    setDT(bmi_t2d)
}
...
rio::export(mix, "~/dva/files/mix.tsv")
