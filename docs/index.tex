...
\begin{frame}[label={sec:orge78999b}]{Background}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc377f96}]{Aims}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org2d74a9d}]{Phenome-wide scan - Data collection}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf891b7b}]{Phenome-wide comparison}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgc736ca0}]{Phenome-wide comparison - SNP-Trait matrix}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge8331cd}]{PCA}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc79b8a7}]{Random Forest (RF)}
\begin{itemize}
