...
\begin{frame}[label={sec:orgea06051}]{Background}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org660feed}]{Aims}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgddd7dcd}]{Phenome-wide scan - Data collection}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org054ab3c}]{Phenome-wide comparison}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org559108d}]{Phenome-wide comparison - SNP-Trait matrix}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org07d9dc9}]{PCA}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org46d4a33}]{Random Forest (RF)}
\begin{itemize}
